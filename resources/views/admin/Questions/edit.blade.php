    ...
    <section class="section">
      ...
      <div class="row">
        ...
        @endif
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update Question,{{$question->id}}</h5>
              ...
              <form method="POST" action="{{route('admin.Question.update',$question->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group my-2">
                    <label>Title</label>
                    <input type="text" name="title" value="{{$question->title}}" class="form-control   @error('title') is-invalid @enderror" required>
                    @error('title')
                ...
                <div class="form-group my-2">
                    <label>Body</label>
                    <input type="text" name="body" value="{{$question->body}}"  class="form-control @error('body') is-invalid @enderror" required>
                    @error('body')
                        <span class="text-danger">* {{ $message }} </span>
                    @enderror
                </div>
